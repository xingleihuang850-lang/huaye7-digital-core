...
| `experiments/花页7_PlanB_记录/phase2/b1_gray_sus/slices_ct28_gray_128/` | B1 灰度 `sus` DDPM 数据集轻量证据 | 是 | 待跟踪 | `src/hy7_phase2_make_gray_slices.py`、`notes/26_阶段二_B1灰度介质生成设计.md` | 远程大数组不入 git：`train.npy`/`test.npy`/`test_pore.npy`；本地仅保存 `meta.json`、`verify_summary.json`、`sha256.txt`、README。 |
