...
| `experiments/花页7_PlanB_记录/phase2/b1_gray_sus/p0_audit_structure_20260703/` | B1.1 P0 归一化链条审计 + 灰度场结构诊断 | 是 | 待跟踪 | `run_b1_p0_audit_structure_20260703.py`、`notes/29_阶段二_B11_P0审计与花页7DLIS盘点.md` | 加载链条未发现明显尺度 bug；train mean=-0.0926 vs generated=-0.4319，说明暗移更像采样/模型分布偏移；generated 低频能量高于真实（0.5068 vs 0.4339），支持结构偏软/簇偏大解释。 |
| `experiments/花页7_PlanB_记录/phase4/dlis_1211_0740_s3473p2_20260703/` | 花页7电成像/测井 DLIS `1211_0740_s3473.2.dlis` 轻量盘点与 4199.21m 预览 | 是 | 待跟踪 | `process_hy7_dlis_1211_0740_s3473p2.py`、`notes/29_阶段二_B11_P0审计与花页7DLIS盘点.md` | 原始 DLIS 不入 git；记录 sha256、frame/channel inventory、4199.21±2m scalar CSV 与 XPADS 电成像预览。深度覆盖约 3873–4313m，目标深度在 3 个 frame 内。 |
